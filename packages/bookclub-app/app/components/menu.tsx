      ...
      >
        <div className="flex lg:flex-2">
          <a href="#" className="-m-1.5 p-1.5">
            <span className="sr-only">Clube do Livro NFT</span>
            <img className="h-8 w-auto" src="/logo-semfundo-dark.svg" alt="" />
          </a>
        </div>
        ...
        {isConnected ? (
          <div className="pl-4 hidden lg:flex lg:flex-2 lg:justify-end">
            <a
              href="#"
              className="text-sm font-semibold leading-6 text-gray-900"
            >
